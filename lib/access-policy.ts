...
function policyUrl(env: {ACCESS_ACCOUNT_ID?:string;ACCESS_POLICY_ID?:string}) {
  return `https://api.cloudflare.com/client/v4/accounts/${encodeURIComponent(env.ACCESS_ACCOUNT_ID!)}/access/policies/${encodeURIComponent(env.ACCESS_POLICY_ID!)}`;
}
